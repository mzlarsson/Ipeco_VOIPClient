...
public class LobbyFragment extends AppConnectFragment implements CCreateRoomDialog.CRDListener {
    ...
    private void createNewRoomOnClick() {
        ...
        if (!truckMode) {
            dialog = new CCreateRoomDialog(getContext(), this, model.getCurrentUserAlias() + "'s room" );
            dialog.show();
