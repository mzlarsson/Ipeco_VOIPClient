...
public class Mute extends BasicCommand{
	
	public Mute(int execCode){
		super(new CommandInfo("Mute", "Mute [muterID] [mutedID]", "Makes a user muted to another user", execCode));
	}
