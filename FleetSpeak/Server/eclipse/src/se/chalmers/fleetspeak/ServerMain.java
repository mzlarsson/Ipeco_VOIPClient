...
public class ServerMain {
	...
	public static void main(String[] args) throws IOException {
		...
		int tcpPort = (args != null && args.length > 0 ? Integer
				.parseInt(args[0]) : DEFAULT_PORT_TCP);
		int rtpPort = (args != null && args.length > 1 ? Integer
				.parseInt(args[1]) : DEFAULT_PORT_RTP);
